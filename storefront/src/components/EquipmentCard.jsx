 ...
 * price, hover-lift, and a clear unavailable state for maintenance/archived.
 */
export default function EquipmentCard({ item }) {
  ...
  return (
    <Link
      to={`/catalog/${item.id}`}
      className="group flex flex-col overflow-hidden rounded-xl border border-slate-200 bg-white transition duration-200 hover:-translate-y-1 hover:shadow-lg"
    >
